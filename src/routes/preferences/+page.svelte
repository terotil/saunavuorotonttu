<script lang="ts">
	...
	// Selected and ordered slot IDs (initialised from server data once on mount)
	...
	// All available slot IDs (for unselected list)
	...
	// Group unselected by day for display
...
<div class="page">
	...
	{:else}
		<div class="columns">
			...
			<!-- Right: ordered preference list + submit -->
			<section class="panel">
